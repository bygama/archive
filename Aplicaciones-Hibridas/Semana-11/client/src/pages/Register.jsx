...
// decodifica el payload del jwt para sacar { id, name, email } sin libreria
function decodeJwt(token) {
  try { return JSON.parse(atob(token.split('.')[1])); } catch { return null; }
}

export default function Register({ onRegistered, goLogin, onBack }) {
  ...
  return (
    <AuthLayout title="Crear cuenta" subtitle="Registrate para guardar tu maletín" onBack={onBack}>
